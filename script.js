...
(() => {
    ...
    var e = {
        733: (e, t, r) => {
            ...
            x.prototype.eos = function () {
                ...
                if (o.hasOwnProperty(e)) t = o[e]; else {
                    for (var i, s, a, l = this, p = !1; l;) {
                        if (e.indexOf(".") > 0) for (i = l.view, s = e.split("."), a = 0; null != i && a < s.length;) a === s.length - 1 && (p = y(i, s[a]) || (r = i, n = s[a], null != r && "object" != typeof r && r.hasOwnProperty && r.hasOwnProperty(n))), i = i[s[a++]]; else i = l.view[e], p = y(l.view, e);
                        if (p) {
                            t = i;
                            break
                        }
                ...
                var r = this.templateCache, n = e + ":" + (t || V.tags).join(":"), o = void 0 !== r,
                    i = o ? r.get(n) : void 0;
                return null == i && (i = function (e, t) {
                    ...
                    function b(e) {
                        ...
                        r = new RegExp(d(e[0]) + "\\s*"), n = new RegExp("\\s*" + d(e[1])), o = new RegExp("\\s*" + d("}" + e[1]))
                    }

                    b(t || V.tags);
                    for (var E, T, k, M, P, L, B = new x(e); !B.eos();) {
                        if (E = B.pos, k = B.scanUntil(r)) for (var G = 0, U = k.length; G < U; ++G) i = M = k.charAt(G), function (e, t) {
                            return m.call(e, t)
                        }(v, i) ? (u = !0, s = !0, h += " ") : (p.push(l.length), h += M), l.push(["text", M, E, E + 1]), E += 1, "\n" === M && (y(), h = "", g = 0, s = !1);
                        if (!B.scan(r)) break;
                        if (c = !0, T = B.scan(C) || "name", B.scan(w), "=" === T ? (k = B.scanUntil(W), B.scan(W), B.scanUntil(n)) : "{" === T ? (k = B.scanUntil(o), B.scan(S), B.scanUntil(n), T = "&") : k = B.scanUntil(n), !B.scan(n)) throw new Error("Unclosed tag at " + B.pos);
                        if (P = ">" == T ? [T, k, E, B.pos, h, g, s] : [T, k, E, B.pos], g++, l.push(P), "#" === T || "^" === T) a.push(P); else if ("/" === T) {
                            if (!(L = a.pop())) throw new Error('Unopened section "' + k + '" at ' + E);
                            if (L[1] !== k) throw new Error('Unclosed section "' + L[1] + '" at ' + E)
                        } else "name" === T || "{" === T || "&" === T ? u = !0 : "=" === T && b(k)
                    }
                    if (y(), L = a.pop()) throw new Error('Unclosed section "' + L[1] + '" at ' + B.pos);
                    return function (e) {
                ...
                var o = this.getConfigTags(n), i = this.parse(e, o), s = t instanceof E ? t : new E(t, void 0);
                ...
                var n = this.getConfigEscape(r) || V.escape, o = t.lookup(e[1]);
                if (null != o) return "number" == typeof o && n === V.escape ? String(o) : n(o)
            ...
            }, V.Scanner = x, V.Context = E, V.Writer = T;
            const M = V;
            ...
            const G = "https://unpkg.com/@workadventure/scripting-api-extra@1.0.5/dist";
            let U, j = 0, O = 0;
            ...
            function I(e) {
                const t = u(Z(e)), r = 32 * ((t.right - t.left) / 2 + t.left),
            ...
            function z(e, t, r, n) {
                ...
                WA.room.onEnterZone(l, (() => {
                    a = !0, r.getBoolean("autoOpen") && c ? WA.state[t.name] = !0 : WA.state[t.name] || (!h || c) && h || !r.getString("code") && !r.getString("codeVariable") ? c && (WA.state[t.name] ? f() : g()) : function (e) {
                        const r = u(Z(t.properties.mustGetString("closeLayer").split("\n")));
                    ...
                    a && (r.getBoolean("autoClose") || !0 !== WA.state[t.name] || f(), s && !0 === WA.state[t.name] && d(), r.getBoolean("autoOpen") || !1 !== WA.state[t.name] || g())
                }))
            }
            ...
            function N(e) {
                void 0 === WA.state[e.name] && (WA.state[e.name] = 0), WA.state.onVariableChange(e.name).subscribe((() => {
                    WA.state[e.name] && function (e) {
                        ...
                        let n = 1;
                        if (r) {
                            const t = Math.sqrt(Math.pow(e.x - j, 2) + Math.pow(e.y - O, 2));
                            if (t > r) return;
                            n = 1 - t / r
                        }
            ...
            function F() {
                return WA.onInit().then((() => {
                    q().catch((e => console.error(e))), async function () {
                        const e = await l();
                        for (const t of e.values()) $(new n(t.properties))
                        ...
                        if (t) {
                            ...
                            r && !WA.player.tags.includes(r) || WA.ui.registerMenuCommand("Configure the room", (() => {
                                e = null != e ? e : G, WA.nav.openCoWebSite(e + "/configuration.html", !0)
                            }))
                        }
                    }().catch((e => console.error(e))), L().catch((e => console.error(e)))
                }))
            }
        }
    }, t = {};
    ...
    r.d = (e, t) => {
        ...
        const t = new Date, n = t.getHours() + ":" + t.getMinutes();
        ...
        //
        // More custom scripts here I guess ...
        //

        WA.chat.sendChatMessage('Hello World', 'MrRobot');
